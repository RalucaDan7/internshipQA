Feature: Search-UI-Check Search Function
  ...
  @Tickbird-004 @Automation_Smoke @UI @Octavian
  ...
  @Tickbird-005 @Automation_Smoke @UI @Octavian
  ...
  @Tickbird-006 @Automation_Smoke @UI @Octavian
  ...
  @Tickbird-007 @Automation_Smoke @UI @Octavian
  ...
  @Tickbird-008 @Automation_Smoke @UI @Octavian
